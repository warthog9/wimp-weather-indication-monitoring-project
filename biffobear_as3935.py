...
# Copyright John 'Warthog9' Hawley
#
# SPDX-License-Identifier: MIT
#
# Note: This is a modified version of the original code to work on micropython
#       as opposed to CircuitPython.
#
...
MicroPython driver library for the AS3935 lightning detector over SPI or I2C
buses.
...
class AS3935_Sensor:
    ...
    def __init__(self, *, interrupt_pin):
        self._interrupt_pin = Pin(interrupt_pin, Pin.IN)
        #self._interrupt_pin.direction = Pin.IN
    ...
    def energy(self):
        ...
        return ((mmsb << _0X10) | (msb << _0X08) | lsb) & const(0x3FFFFF)
    ...
    def distance(self):
        ...
        if distance == _0X3F:  # Storm out of range
            distance = None
        elif distance == _0X01:  # Storm overhead
            distance = _0X00
    ...
    def clear_stats(self):
        ...
        """
        self._set_register(self._CL_STAT, _0X01)
        self._set_register(self._CL_STAT, _0X00)
        self._set_register(self._CL_STAT, _0X01)
    ...
    def power_down(self, value):
        ...
        if value:
            ...
            self._set_register(self._DISP_FLAGS, _0X02)
            time.sleep(0.002)
            self._set_register(self._DISP_FLAGS, _0X00)
    ...
    def _check_clock_calibration(self):
        ...
        while not (trco_result and srco_result):
            ...
            if ( end - start )> 1000000000:
                print("Ok something wonky")
                print(str( end ) +" - "+ str( start ) +" > "+ str(_0X01) +": "+ str( ( end - start )> _0X01 ) )
                print(str( end ) +" - "+ str( start ) +": "+ str( end - start  ) )
                raise OSError(
                    "Problem communicating with the sensor. Check your wiring."+ str(start) +" - "+ str(end) +" - "+ str(_0X01)
                )
